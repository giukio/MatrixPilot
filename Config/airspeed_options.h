...
#define MINIMUM_AIRSPEED            6.0
#define MAXIMUM_AIRSPEED            15.0
#define CRUISE_AIRSPEED             9.0    // Gliding airspeed when aircraft is level
...
#define AIRSPEED_PITCH_KI           0.005    // Integrataion rate.  High = unstable, low = slow response.
#define AIRSPEED_PITCH_KI_MAX       15.0     // Limit of integration control in degrees.  Start with 5.0.
